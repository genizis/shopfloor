...
})(window,document,'script','dataLayer','GTM-5QG4XHV');</script>
...
<script src="<?= base_url('/pwabuilder-sw/pwabuilder-sw.js'); ?>" type="text/javascript"></script> 
<script src="<?= base_url('/pwabuilder-sw/pwabuilder-sw-register.js'); ?>" type="text/javascript"></script>
