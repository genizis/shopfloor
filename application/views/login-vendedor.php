        ...
        <div class="container">
            <div class="row login">
                ...
                <div class="col-md-4">
                    ...
                    <div class="card ">
                        <div class="card-body">
                            <legend><strong>Acesso vendedor</strong></legend>
                            <hr>
                            ...
                            <form action="<?= base_url('login-vendedor') ?>" method="POST" id="login" class="mb-0 needs-validation" novalidate>
                                <fieldset> 
                                    <div class="form-row">                                 
                                        <div class="form-group col-md-12">
                                            <label class="col-form-label" for="inputIDCliente">ID Cliente <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="inputIDCliente" name="IDCliente" 
                                                value="<?= set_value('IDCliente') ?>" required>
                                        </div>
                                    </div>  
                                    <div class="form-row">                                 
                                        <div class="form-group col-md-12">
                                            <label class="col-form-label" for="inputUsuarioVendedor">Usuário Vendedor <span class="text-danger">*</span></label>
