...
<section>
    <div class="container">
        <form action="<?php echo base_url("vendas/frente-caixa/{$dia}/nova-venda-caixa") ?>" method='post' class="mb-0 needs-validation" novalidate>
            <div class="row">
                        ...
                        <div class="tab-pane fade" id="cliente">
                            <div class="row  button-pane">
                                <div class="col-lg-12 col-md-12 col-xs-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-12">
                                            <a href="#" data-toggle="modal" data-target="#novo-cliente" type="button" class="btn btn-outline-info btn-block"><i
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                <input type="text" class="form-control" data-mask="#.##0,00"
                                                    ...
                                                    id="inputValorDesconto" value="<?= set_value('Desconto'); ?>">
                                            </div>
                                        </div>
                                        <div class="form-group col-md-4">
                        ...
                        <div class="card-body">
                            <div class="row">
                                <div class="col-lg-12 col-md-12 col-xs-12">
                                    ...
                                    <div class="row">
                                        <div class="col-md-6">
                                            <a href="#" type="button" class="btn btn-outline-warning disabled" id="btnImprimir"><i
