                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <select id="inputSituacao" class="selectpicker show-tick form-control"
                                                ...
                                                <option value="1" <?php if($pedido->situacao == 1) echo "selected"; ?>>Em Orçamento</option>
                                                <option value="2" <?php if($pedido->situacao == 2) echo "selected"; ?>>Orçamento Reprovado</option>
                                                <option value="3" <?php if($pedido->situacao == 3) echo "selected"; ?>>Venda Confirmada</option>
                                            </select>
                                            <?php }else{ ?>
                                                <input class="form-control" id="inputCodCliente" type="text" disabled
                                                value="<?php
                                    ...
                                    <div class="form-row">
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="input-group">
                                                ...
                                                value="<?= number_format($pedido->perc_comissao, 2, ',', '.') ?>" <?php if($pedido->cod_vendedor == null) echo "disabled"; ?>>
                                        ...
                                        <div class="form-group col-md-3">
                                            ...
                                            <div class="input-group">
                                                <select id="inputTipoFrete" class="selectpicker show-tick form-control"
                                                    ...
                                                    <option value="1" <?php if($pedido->tipo_frete == 1) echo "selected"; ?>>CIF R$</option>
                                                    <option value="2" <?php if($pedido->tipo_frete == 2) echo "selected"; ?>>FOB R$</option>
                                                </select>
                                                <input type="text" class="form-control" data-mask="#.##0,00" data-mask-reverse="true"
                                                        name="Frete" value="<?= number_format($pedido->valor_frete, 2, ',', '.') ?>">
                                            </div>
                                        </div>                                      
                                    </div>
                                    <div class="form-row">
                                        ...
                                        <div class="row">
                                            <div class="col-lg-12 col-md-12 col-xs-12">
                                                <button data-toggle="modal" data-target="#inserir-produto" type="button"
                                                    class="btn btn-outline-info btn-sm"><i class="fas fa-plus-circle"></i> Adicionar
                                                    Produto</button>
                                                <button data-toggle="modal" data-target="#elimina-produto" type="button"
                                                    class="btn btn-outline-danger btn-sm" id="excluirProduto" disabled><i
                                            ...
                                            <table class="table table-bordered table-hover">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td class="text-center"><?= number_format($produto_venda->quant_pedida, 3, ',', '.') ?>
                                                        </td>
                                                        <td class="text-center"><?= number_format($produto_venda->quant_atendida, 3, ',', '.') ?>
                                                        </td>
                                                        <td class="text-center">R$ <?= number_format($produto_venda->valor_unitario * $produto_venda->quant_pedida, 2, ',', '.') ?>
                                                        </td>
                                                ...
                                                <div class="col-md-4">
                                                    <table class="table table-bordered">
                                                        <tbody>                                                            
                                                            ...
                                                            <?php } ?>
                                                            <tr>
                                                                <?php if($pedido->tipo_frete == 1) $frete = $pedido->valor_frete; else $frete = 0; ?>
                                                                    ...
                                                                    <?php                                                                          
                                                                         if($pedido->valor_desconto != 0){
                                                                            if($pedido->tipo_desconto == 1){
                                                                                echo number_format($total + $frete - $pedido->valor_desconto, 2, ',', '.');
                                                                            }elseif($pedido->tipo_desconto == 2){
                                                                                echo number_format($total + $frete - ($total * ($pedido->valor_desconto / 100)), 2, ',', '.');
                                                                            }
                                                                         }else{
                                                                             echo number_format($total + $frete, 2, ',', '.');
                                                                         }
                                                                    ?>
                                                                 </strong></td>
                                                            </tr>                                                         
                                            ...
                                            <div class="row float-right">
                                                <div class="col-md-12">
                                                    ...
                                                    <a href="<?php echo base_url() ?>vendas/faturamento-pedido/novo-faturamento-pedido/<?= $pedido->num_pedido_venda ?>"
                                                        class="btn btn-info <?php if($pedido->situacao != 3) echo "disabled"; ?>" ><i class="fas fa-dollar-sign"></i> Faturar Pedido</a>
                        ...
                        <form class="mb-0 needs-validation" novalidate
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    <label for="inputProdutoVenda">Código do Produto <span class="text-danger">*</span></label>
                                ...
                                <div class="form-group col-md-3">
                                    ...
                                    <input class="form-control" id="inputTipoProduto" type="text"
                                        name="TipoProduto" readonly
                                        value="<?= set_value('TipoProduto'); ?>">
                                </div>
                                <div class="form-group col-md-3">
                                    ...
                                    <input class="form-control" id="inputUnidadeMedida" type="text"
                                        name="UnidadeMedida" readonly
                                        value="<?= set_value('UnidadeMedida'); ?>">
                                </div>
                            </div>
                            <div class="form-row">  
                                <div class="form-group col-md-4">
                                    <label for="inputQuantPedida">Quantidade Pedida <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" 
                                        id="inputQuantPedida" name="QuantPedida" data-mask="#.##0,000" data-mask-reverse="true"
                                        value="<?= set_value('QuantPedida'); ?>" required>
                                </div>
                                <div class="form-group col-md-4">
                                    <label class="control-label" for="inputValorUnitario">Valor do Unitário <span class="text-danger">*</span></label>
                                    <div class="input-group">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" class="form-control" readonly
                                            id="inputTotalVenda" type="text" name="TotalVenda" data-mask="#.##0,00" data-mask-reverse="true"
...
<div class="modal fade" id="editar-produto<?= $produto_venda->seq_produto_venda ?>">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <input class="form-control" id="inputProdutoVendaEdit" type="text"
                                        name="CodProdutoEdit" value="<?= $produto_venda->cod_produto ?> - <?= $produto_venda->nome_produto ?>" readonly>
                                </div>
                                <div class="form-group col-md-3">
                                    ...
                                    <input class="form-control" id="inputTipoProdutoEdit" type="text"
                                        name="TipoProdutoEdit" value="<?= $produto_venda->nome_tipo_produto ?>" readonly>
                                </div>
                                <div class="form-group col-md-3">
                                    ...
                                    <input class="form-control" id="inputUnidadeMedidaEdit" type="text"
                                        name="UnidadeMedidaEdit" value="<?= $produto_venda->cod_unidade_medida ?>" readonly>
                                </div>
                            </div>
                            <div class="form-row">                                
                                <div class="form-group col-md-4">
                                    <label for="inputQuantPedidaEdit">Quantidade Pedida <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control" value="<?= $produto_venda->quant_pedida ?>" data-mask="#.##0,000" data-mask-reverse="true"
                                        id="inputQuantPedidaEdit" name="QuantPedidaEdit">
                                </div>
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" class="form-control"
                                            id="inputValorUnitarioEdit" type="text" name="ValorUnitarioEdit" data-mask="#.##0,00" data-mask-reverse="true"
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" class="form-control" readonly
                                            id="inputValorTotalEdit" type="text" name="ValorTotalEdit" data-mask="#.##0,00" data-mask-reverse="true"
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary" form="formProdutoVendaEdit<?= $produto_venda->seq_produto_venda ?>"><i class="fas fa-save"></i>
                    Salvar</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
            </div>
        </div>
