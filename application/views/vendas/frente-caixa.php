            ...
            <div class="modal-body modal-body-scroll">
                <form action="<?php echo base_url("vendas/fechar-caixa/{$dia}") ?>" method='post'
                    ...
                    <table class="table table-bordered">
                        ...
                        <tbody>
                            <tr>
                                <td class="text-center <?php if($frente_caixa->total_venda_geral > 0) echo "text-teal"; ?>">R$
                                    <?= number_format($frente_caixa->total_venda_geral, 2, ',', '.') ?></td>
                                <td class="text-center <?php if(($frente_caixa->total_venda_geral - $frente_caixa->total_venda_liquido) > 0) echo "text-warning"; ?>">R$
                                    <?= number_format($frente_caixa->total_venda_geral - $frente_caixa->total_venda_liquido, 2, ',', '.') ?>
                                </td>
                                <td class="text-center <?php if($frente_caixa->total_venda_liquido > 0) echo "text-teal"; ?>">
                                <strong>R$ <?= number_format($frente_caixa->total_venda_liquido, 2, ',', '.') ?></strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
                        ...
                        <tbody>
                            ...
                            <tr>
                                ...
                                <td class="text-center text-teal">
                                    <strong>R$ <?= number_format($frente_caixa->saldo_inicial + $frente_caixa->total_venda + $frente_caixa->total_incremento - $frente_caixa->total_recolhimento, 2, ',', '.') ?><strong>
                                </td>
                            </tr>
                        </tbody>
                    </table>
