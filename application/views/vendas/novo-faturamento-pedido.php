                                ...
                                <div class="form-row">
                                    <div class="form-group col-md-2">
                                        ...
                                        <input type="text" class="form-control" id="inputPedido"
                                            value="<?= $pedido->num_pedido_venda ?>" readonly>
                                    </div>
                                    <div class="form-group col-md-7">
                                        <label for="inputCliente">Cliente</label>
                                        <input type="text" class="form-control" id="inputCliente"
                                            value="<?= $pedido->cod_cliente ?> - <?= $pedido->nome_cliente ?>" readonly>
                                    </div>
                                ...
                                <div class="form-row">
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="inputValorPedido" type="text"
                                                name="TotalPedidoVenda" data-mask="#.##0,00" data-mask-reverse="true"
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="inputDesconto" type="text"
                                                name="ValorDesconto" data-mask="#.##0,00" data-mask-reverse="true"
                                    ...
                                    <div class="form-group col-md-3">
                                        ...
                                        <div class="input-group">
                                            ...
                                            <input type="text" class="form-control" id="inputFrete" type="text"
                                                name="inputFrete" data-mask="#.##0,00" data-mask-reverse="true" 
                                                value="<?= number_format($pedido->valor_frete, 2, ',', '.') ?>" readonly>
                                        </div>
                                    </div>
                                </div>
                                <div class="form-row">
                                    <div class="form-group col-md-12">
                                        ...
                                        <textarea class="form-control" rows="3" id="inputObservacao"
                                            readonly><?= $pedido->observacoes ?></textarea>
                                    </div>
                                </div>
                                <hr>
                                <div class="row">
                                            ...
                                            <ul class="nav nav-tabs">
                                                <li class="nav-item">
                                                    <a class="nav-link active" data-toggle="tab"
                                                        href="#faturamento">Faturamentos do Pedido</a>
                                                </li>
                                                <li class="nav-item">
                                            ...
                                            <div class="tab-pane fade active show" id="faturamento">
                                                <div class="row  button-pane">
                                                    <div class="col-md-12">
                                                        ...
                                                        <button data-toggle="modal" data-target="#produto-faturado"
                                                            type="button" class="btn btn-outline-secondary btn-sm"><i
                                                                class="fas fa-list"></i> Produtos Faturados</button>
                                                    </div>
                                                </div>
                                                    ...
                                                    <table class="table table-bordered table-hover table-nf">
                                                        ...
                                                        <tbody>
                                                            ...
                                                            <tr>
                                                                ...
                                                                <td class="text-center text-muted"><span
                                                                        class='badge badge-secondary'>NF Não
                                                                        Emitida</span></td>
                                                                <td class="text-center"><a href="#" data-toggle="modal"
                                                                        data-target="#emitir-nf<?= $faturamento->cod_faturamento_pedido ?>"
                                                                        type="button"
                                                                        class="btn btn-outline-teal btn-sm">Emitir
                                                                        NF</a>
                                                                </td>
                                                            </tr>
                                                            <?php } ?>
                                    ...
                                    <tr>
                                        <td class="text-center" id="inputValorBruto"><strong>R$
                                                ...
                                                <input class="form-control text-center" id="inputBruto"
                                                    ...
                                                    data-mask-reverse="true" value="<?= number_format($valorPendente, 2, ',', '.') ?>"></td>
                                        <td class="text-center">
                                            <div class="input-group">
                                                <div class="input-group-prepend">
                                                    <span class="input-group-text">R$</span>
                                                </div>
                                                <input class="form-control text-center" id="inputValorFrete"
                                                    name="ValorFrete" type="text" data-mask="#.##0,00"
                                                    data-mask-reverse="true" value="<?= number_format($valorFrete, 2, ',', '.') ?>">
                                            </div>
                                        </td>
                                        <td class="text-center">
                                            <div class="input-group">
                                                ...
                                                <input class="form-control text-center" id="inputValorDesconto"
                                                    name="ValorDesconto" type="text" data-mask="#.##0,00"
                                            ...
                                            <tr>
                                                ...
                                                <td>
                                                    <input class="form-control text-center"
                                                        ...
                                                        name="quantVendida[<?= $produto->cod_produto ?>]" type="text"
                                                        data-mask="#.##0,000" data-mask-reverse="true"
                                                        value="<?= number_format($quantSaldo, 3, ',', '.') ?>" required>
                                                </td>
                                                <td class="text-center"
                        ...
                        <div class="col-md-12">
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-4">
                                    ...
                                    <select class="form-control selectpicker show-tick" data-live-search="true"
                                        data-style="btn-input-primary" title="Selecione a Cidade" id="inputCidade"
                                        name="Cidade">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="inputContribuinteICMS" name="ContribuinteICMS"
                                        data-style="btn-input-primary" class="selectpicker show-tick form-control"
                                        data-live-search="true" data-actions-box="true">
                                        <option value="9"
                                            <?php if($cliente->tipo_contrib_icms == 9) echo "selected"; ?>>Não
                                            Contribuinte</option>
                                        <option value="1"
                                            <?php if($cliente->tipo_contrib_icms == 1) echo "selected"; ?>>
                                            Contribuinte</option>
                                        <option value="2"
                                            <?php if($cliente->tipo_contrib_icms == 2) echo "selected"; ?>>
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr colspan="6">
                                                        <td class="text-center accordion-toggle">
                                                            <a class="text-teal" data-toggle="collapse"
                                                                data-target="#prod<?= $faturamento_produto->cod_produto ?>">
                                                        ...
                                                        <td>
                                                            <input type="text" class="form-control text-center"
                                                                id="inputTotalVenda" type="text" name="TotalVenda"
                                                                value="<?= $faturamento_produto->cod_ncm ?>">
                                                        </td>
                                                    </tr>
                                                    <tr>
                                                        <td colspan="6" class="hiddenRow">
                                                            <div class="accordian-body collapse p-3"
                                                                id="prod<?= $faturamento_produto->cod_produto ?>">
                                                                <div class="form-row">
                                                                    <div class="form-group col-md-2">
                                                                        <label for="inputOrigemProduto">CEST</label>
                                                                        <input type="text" class="form-control"
                                                                            id="inputTotalVenda" type="text"
                                                                            name="TotalVenda"
                                                                            value="<?= $faturamento_produto->cod_cest ?>">
                                                                    </div>
                                                                    <div class="form-group col-md-5">
                                                                        <label for="inputOrigemProduto">Origem do
                                                                            Produto</label>
                                                                        <select id="inputOrigemProduto"
                                                                            name="OrigemProduto"
                                                                            data-style="btn-input-primary"
                                                                            class="selectpicker show-tick form-control"
                                                                            data-live-search="true"
                                                                            data-actions-box="true"
                                                                            title="Informe a Origem do Produto">
                                                                            <option value="0"
                                                                                <?php if($faturamento_produto->cod_origem == 0) echo "selected"; ?>>
                                                                                0 - Nacional
                                                                            </option>
                                                                            <option value="1"
                                                                                <?php if($faturamento_produto->cod_origem == 1) echo "selected"; ?>>
                                                                                1 - Estrangeira - Importação direta
                                                                            </option>
                                                                            <option value="2"
                                                                                <?php if($faturamento_produto->cod_origem == 2) echo "selected"; ?>>
                                                                                2 - Estrangeira - Adquirida no mercado
                                                                                interno
                                                                            </option>
                                                                            <option value="3"
                                                                                <?php if($faturamento_produto->cod_origem == 3) echo "selected"; ?>>
                                                                                3 - Nacional, mercadoria ou bem com
                                                                                Conteúdo de
                                                                                Importação superior a 40%
                                                                            </option>
                                                                            <option value="4"
                                                                                <?php if($faturamento_produto->cod_origem == 4) echo "selected"; ?>>
                                                                                4 - Nacional, cuja produção tenha sido
                                                                                feita em
                                                                                conformidade com a MP 252(MP do BEM)
                                                                            </option>
                                                                            <option value="5"
                                                                                <?php if($faturamento_produto->cod_origem == 5) echo "selected"; ?>>
                                                                                5 - Nacional, mercadoria ou bem com
                                                                                Conteúdo de
                                                                                Importação inferior ou igual a 40%
                                                                            </option>
                                                                            <option value="6"
                                                                                <?php if($faturamento_produto->cod_origem == 6) echo "selected"; ?>>
                                                                            ...
                                                                            <option value="7"
                                                                                <?php if($faturamento_produto->cod_origem == 7) echo "selected"; ?>>
                                                                            ...
                                                                            <option value="8"
                                                                                <?php if($faturamento_produto->cod_origem == 8) echo "selected"; ?>>
                                                                ...
                                                                <ul class="nav nav-tabs mt-3">
                                                                    <li class="nav-item">
                                                                        <a class="nav-link active" data-toggle="tab"
                                                                            href="#icms<?= $faturamento_produto->cod_produto ?>">ICMS</a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" data-toggle="tab"
                                                                            href="#ipi<?= $faturamento_produto->cod_produto ?>">IPI</a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" data-toggle="tab"
                                                                            href="#pis<?= $faturamento_produto->cod_produto ?>">PIS</a>
                                                                    </li>
                                                                    <li class="nav-item">
                                                                        <a class="nav-link" data-toggle="tab"
                                                                            href="#cofins<?= $faturamento_produto->cod_produto ?>">CONFINS</a>
                                                                    </li>
                                                                </ul>
                                                                <div class="tab-content">
                                                                    <div class="tab-pane fade active show impostos" role="tabpanel" aria-labelledby="home-tab"
                                                                        id="icms<?= $faturamento_produto->cod_produto ?>">
                                                                            ...
                                                                            <div class="form-group col-md-4">
                                                                                ...
                                                                                <div class="input-group">
                                                                                    ...
                                                                                    <input type="text"
                                                                                        ...
                                                                                        value="<?= number_format($faturamento_produto->valor_movimento, 2, ',', '.') ?>">
                                                                                </div>
                                                                            </div>
                                                                            <div class="form-group col-md-4">
                                                                    ...
                                                                    <div class="tab-pane fade impostos" role="tabpanel" aria-labelledby="home-tab"
                                                                        id="ipi<?= $faturamento_produto->cod_produto ?>">
                                                                        <div class="form-row mt-2">
                                                                            <div class="form-group col-md-12">
                                                                                <label for="inputOrigemProduto">Situação
                                                                                    Tributária
                                                                    ...
                                                                    <div class="tab-pane fade impostos" role="tabpanel" aria-labelledby="home-tab"
                                                                        id="pis<?= $faturamento_produto->cod_produto ?>">
                                                                        <div class="form-row mt-2">
                                                                            <div class="form-group col-md-12">
                                                                                <label for="inputOrigemProduto">Situação
                                                                                    Tributária
                                                                    ...
                                                                    <div class="tab-pane fade impostos" role="tabpanel" aria-labelledby="home-tab"
                                                                        id="cofins<?= $faturamento_produto->cod_produto ?>">
                                                                        <div class="form-row mt-2">
                                                                            <div class="form-group col-md-12">
                                                                                <label for="inputOrigemProduto">Situação
                                                                                    Tributária
