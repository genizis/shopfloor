...
<section>
    <div class="container">
        <ol class="breadcrumb">
            ...
            <li class="breadcrumb-item active">Editar Método de Pagamento</li>
        </ol>
    </div>
</section>
                    ...
                    <div class="card-body">
                        <div class="row">
                            <div class="col-lg-12 col-md-12 col-xs-12">
                                ...
                                <form action="<?= base_url("metodo-pagamento/editar-metodo-pagamento/{$metodo_pagamento->cod_metodo_pagamento}") ?>"
                                      method='post' class="needs-validation" novalidate>
                                    <div class="form-row">
                                        <div class="form-group col-md-2">
                                            <label for="inputCodigo">Código</label>
                                            <input type="text" class="form-control" id="inputCodigo" readonly
                                                name='Codigo' value="<?= $metodo_pagamento->cod_metodo_pagamento ?>">
                                        </div>
                                        <div class="form-group col-md-10">
                                            <label for="inputNomeMetodoPagamento">Nome do Método de Pagamento <span class="text-danger">*</span></label>
                                            <input type="text" class="form-control" id="inputNomeMetodoPagamento"
                                                name='NomeMetodoPagamento' value="<?= $metodo_pagamento->nome_metodo_pagamento ?>" required>
                                        </div>
                                    </div>
                                    <div class="form-row">
                                        <div class="form-group col-md-4">
                                            ...
                                            <select class="selectpicker show-tick form-control" data-live-search="true"
                                                data-actions-box="true" title="Selecione uma Financeira"
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <div class="input-group">
                                                ...
                                                value="<?= $metodo_pagamento->taxa_operacao ?>">
                                        ...
                                        <div class="form-group col-md-4">
                                            ...
                                            <input type="text" class="form-control" id="inputDiasRecebimento"
                                                ...
                                                value="<?= $metodo_pagamento->dias_recebimento ?>">
                                        </div>
                                    </div>
                                    <hr>
