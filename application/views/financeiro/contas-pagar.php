    ...
    <div class="container">
        <div class="row">
            <div class="col-md-3">
                            ...
                            <div class="col-md-12">
                                <div class="input-group">
                                    <div class="input-group-prepend">
                                        <a href="<?= base_url("financeiro/contas-pagar/{$mes_anterior}/{$ano_anterior}") ?>"
                                    ...
                                    <div class="input-group-append">
                                        <a href="<?= base_url("financeiro/contas-pagar/{$mes_seguinte}/{$ano_seguinte}") ?>"
                ...
                <div class="row">
                    <div class="col-md-12">
                        <form action="<?= base_url("financeiro/contas-pagar/{$mes}/{$ano}") ?>" method="get"
                            class="mb-0 needs-validation" novalidate>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <select class="selectpicker show-tick form-control" multiple
                                        data-live-search="true" data-actions-box="true" title="Fornecedor"
                                        data-style="btn-input-primary" name="fornecedorFiltro[]">
                                        <?php $chave_fornecedor = 0; foreach($lista_fornecedor as $key_fornecedor => $fornecedor) { ?>
                                        <option value="<?= $fornecedor->cod_fornecedor ?>" <?php if($fornecedorFiltro != null){if($fornecedor->cod_fornecedor == $fornecedorFiltro[$chave_fornecedor]){ 
                                                if((count($fornecedorFiltro) - 1) > $chave_fornecedor) {$chave_fornecedor = $chave_fornecedor + 1; } 
                                                echo "selected"; }}?>>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <select class="selectpicker show-tick form-control" multiple
                                        data-live-search="true" data-actions-box="true" title="Conta Financeiro"
                                        name="ContaFinanceiraFiltro[]" data-style="btn-input-primary">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <select class="selectpicker show-tick form-control" multiple
                                        data-live-search="true" data-actions-box="true" title="Centro de Custo"
                                        name="CentroCustoFiltro[]" data-style="btn-input-primary">
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <select class="selectpicker show-tick form-control" multiple
                                        data-live-search="true" data-actions-box="true" title="Conta Contábil"
                                        name="ContaContabilFiltro[]" data-style="btn-input-primary">
                ...
                <div class="card  mb-3">
                    <div class="card-body">
                        <div class="row">
                            ...
                            <div class="col-md-3">
                                <h3 class="font-weight-bold mb-0 text-right text-danger" id="ValorTotalSel"></h3>
                            </div>
                        </div>
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                <form action="<?= base_url("financeiro/contas-pagar/acao-titulo/{$mes}/{$ano}") ?>"
                                            ...
                                            <tbody>
                                                ...
                                                <tr>
                                                    <td>
                                                        <div class="checkbox text-center">
                                                            <input name="selecionar_todos[]" type="checkbox"
                                                                value="<?= $contas_pagar->cod_movimento_conta ?>" />
                                                        </div>
                                                    </td>
                                                    <td class="text-center">
                                                        <a href="#" data-toggle="modal"
                                                            data-target="#editar-titulo<?= $contas_pagar->cod_movimento_conta ?>">
                                                            <?= $contas_pagar->cod_movimento_conta ?></a>
                                                    </td>
                                                    <td
                                                        class="text-center 
                                                    ...
                                                    <td class="limit-text-50" data-toggle="tooltip" data-placement="bottom" 
                                                        title="<?= $contas_pagar->desc_movimento ?>">
                                                        <?= $contas_pagar->desc_movimento ?>
                                                    </td>
                                                    <td class="text-center"><?= $contas_pagar->parcela ?></td>
                                                    <td class="text-center text-danger"
                                                        id="ValorTitulo<?= $contas_pagar->cod_movimento_conta ?>">
                                                        R$
                                    ...
                                    <div class="text-center">
                                        <p class="text-muted mb-0">Nenhum título encontrado</p>
                                    </div>
                                    <?php } ?>
                                </form>
                            </div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Eliminar Título Contas a Pagar</h5>
...
<div class="modal fade" id="confirma-titulo" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Confirmar Título Contas a Pagar</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
...
<div class="modal fade" id="inserir-titulo">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Adicionar Título Contas a Pagar</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
                ...
                <div class="row">
                    <div class="col-lg-12 col-md-12 col-xs-12">
                        <form class="mb-0 needs-validation" novalidate
                            action="<?= base_url("financeiro/contas-pagar/inserir-titulo/{$mes}/{$ano}") ?>"
                            ...
                            <div class="form-row">
                                ...
                                <div class="form-group col-md-6">
                                    <label for="inputConta">Conta Financeira <span class="text-danger">*</span></label>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select id="inputCentroCusto" class="selectpicker show-tick form-control"
                                        ...
                                        title="Selecione um Centro Custo" name="CodCentroCusto"
                            ...
                            <div class="form-row" id="dataConfirmacao" style="display: none">
                                ...
                                <div class="form-group col-md-3">
                                    <label class="control-label" for="inputValorPagar">Valor a Pagar</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">R$</span>
                                        </div>
                                        <input type="text" class="form-control" class="form-control" readonly
                                            id="inputValorPagar" type="text" name="ValorPagar" data-mask="#.##0,00"
                                            data-mask-reverse="true" value="<?= set_value('ValorPagar'); ?>">
                                    </div>
                                </div>
                            </div>
                        </form>
...
<div class="modal fade" id="editar-titulo<?= $contas_pagar->cod_movimento_conta ?>">
    <div class="modal-dialog modal-dialog-centered modal-xl" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <h5 class="modal-title">Editar Título Contas a Pagar</h5>
                <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                    <span aria-hidden="true">&times;</span>
                </button>
            </div>
            <div class="modal-body">
                <div class="row">
                    <div class="col-md-12">
                        <form class="mb-0 needs-validation" novalidate
                            action="<?= base_url("financeiro/contas-pagar/editar-titulo/{$contas_pagar->cod_movimento_conta}/{$mes}/{$ano}") ?>"
                            method='post' id='formTitulo<?= $contas_pagar->cod_movimento_conta ?>'>
                            <div class="form-row">
                                <div class="form-group col-md-3">
                                    <label class="control-label">Título</label>
                                    <input class="form-control" type="text"
                                        value="<?= $contas_pagar->cod_movimento_conta ?>" readonly>
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label">Data de Competência</label>
                                    <input class="form-control" type="text"
                                        value="<?= str_replace('-', '/', date("d-m-Y", strtotime($contas_pagar->data_competencia))) ?>"
                                        readonly>
                                </div>
                                <div class="form-group col-md-3">
                                    ...
                                    <div class="input-group">
                                        ...
                                        <input type="text" class="form-control" class="form-control"
                                            id="inputValorTitulo<?= $contas_pagar->cod_movimento_conta ?>" type="text"
                                            name="ValorTitulo" data-mask="#.##0,00" data-mask-reverse="true"
                                            value="<?= $contas_pagar->valor_titulo ?>" required>
                                    </div>
                                </div>
                                <div class="form-group col-md-3">
                                    <label>Data de Vencimento <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control"
                                        id="inputDataVencimentoEdit<?= $contas_pagar->cod_movimento_conta ?>"
                                        name="DataVencimento"
                                        value="<?= str_replace('-', '/', date("d-m-Y", strtotime($contas_pagar->data_vencimento))) ?>" required>
                                </div>
                            </div>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <select class="selectpicker show-tick form-control" data-live-search="true"
                                        ...
                                        <?php foreach($lista_fornecedor as $key_fornecedor => $fornecedor) { ?>
                                        <option value="<?= $fornecedor->cod_fornecedor ?>"
                                            <?php if($fornecedor->cod_fornecedor == $contas_pagar->cod_emitente) echo "selected"; ?>>
                                            <?= $fornecedor->cod_fornecedor ?> -
                                            <?= $fornecedor->nome_fornecedor ?></option>
                                        <?php } ?>
                                    </select>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="selectpicker show-tick form-control" data-live-search="true"
                                        ...
                                        <?php foreach($lista_metodo_pagamento as $key_metodo_pagamento => $metodo_pagamento) { ?>
                                        <option value="<?= $metodo_pagamento->cod_metodo_pagamento ?>"
                                            <?php if($metodo_pagamento->cod_metodo_pagamento == $contas_pagar->cod_metodo_pagamento) echo "selected"; ?>>
                                            <?= $metodo_pagamento->cod_metodo_pagamento ?> -
                                            <?= $metodo_pagamento->nome_metodo_pagamento ?>
                                        </option>
                                        <?php } ?>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="selectpicker show-tick form-control" data-live-search="true"
                                        ...
                                        <?php foreach($lista_conta as $key_conta => $conta) { ?>
                                        <option value="<?= $conta->cod_conta ?>"
                                            <?php if($conta->cod_conta == $contas_pagar->cod_conta) echo "selected"; ?>>
                                            <?= $conta->cod_conta ?> - <?= $conta->nome_conta ?>
                                        </option>
                                        <?php } ?>
                                    </select>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="selectpicker show-tick form-control" data-live-search="true"
                                        ...
                                        <?php foreach($lista_centro_custo as $key_centro_custo => $centro_custo) { ?>
                                        <option value="<?= $centro_custo->cod_centro_custo ?>"
                                            <?php if($centro_custo->cod_centro_custo == $contas_pagar->cod_centro_custo) echo "selected"; ?>>
                                            <?= $centro_custo->cod_centro_custo ?> -
                                            <?= $centro_custo->nome_centro_custo ?>
                                        </option>
                                        <?php } ?>
                                ...
                                <div class="form-group col-md-6">
                                    ...
                                    <select class="selectpicker show-tick form-control" data-live-search="true"
                                        ...
                                        <?php foreach($lista_conta_contabil as $key_conta_contabil => $conta_contabil) { ?>
                                        <option value="<?= $conta_contabil->cod_conta_contabil ?>"
                                            <?php if($conta_contabil->cod_conta_contabil == $contas_pagar->cod_conta_contabil) echo "selected"; ?>>
                                            <?= $conta_contabil->cod_conta_contabil ?> -
                                            <?= $conta_contabil->nome_conta_contabil ?>
                                        </option>
                                        <?php } ?>
                            ...
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    ...
                                    <input class="form-control" type="text" name="Descricao"
                                        value="<?= $contas_pagar->desc_movimento ?>">
                                </div>
                            </div>
                            <hr>
                            <div class="form-row">
                                <div class="form-group col-md-12">
                                    <div class="custom-control custom-checkbox">
                                        <input type="checkbox" class="custom-control-input"
                                            id="inputConfirmarEdit<?= $contas_pagar->cod_movimento_conta ?>"
                                            name="Confirmar" value="1"
                                            <?php if($contas_pagar->confirmado == 1) echo "checked"; ?>>
                                        <label class="custom-control-label"
                                            for="inputConfirmarEdit<?= $contas_pagar->cod_movimento_conta ?>">Confirmar
                                            Título</label>
                                    </div>
                                </div>
                            </div>
                            <div class="form-row" id="dataConfirmacao<?= $contas_pagar->cod_movimento_conta ?>"
                                style="display: none">
                                <div class="form-group col-md-3">
                                    <label class="control-label"
                                        for="inputDataConfirmacao<?= $contas_pagar->cod_movimento_conta ?>">Data de
                                        Confirmação <span class="text-danger">*</span></label>
                                    <input type="text" class="form-control"
                                        id="inputDataConfirmacao<?= $contas_pagar->cod_movimento_conta ?>"
                                        name="DataConfirmacao" value="<?= set_value('DataConfirmacao') ?>">
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label"
                                        for="inputValorDescontoTaxas<?= $contas_pagar->cod_movimento_conta ?>">Descontos
                                        e Taxas</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">R$</span>
                                        ...
                                        <input type="text" class="form-control" class="form-control"
                                            id="inputValorDescontoTaxas<?= $contas_pagar->cod_movimento_conta ?>"
                                            type="text" name="ValorDescontoTaxas" data-mask="#.##0,00"
                                            data-mask-reverse="true" value="<?= $contas_pagar->valor_desc_taxa ?>">
                                    </div>
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label"
                                        for="inputValorMultasJustos<?= $contas_pagar->cod_movimento_conta ?>">Multas e
                                        Juros</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">R$</span>
                                        ...
                                        <input type="text" class="form-control" class="form-control"
                                            id="inputValorMultasJustos<?= $contas_pagar->cod_movimento_conta ?>"
                                            type="text" name="ValorMultasJustos" data-mask="#.##0,00"
                                            data-mask-reverse="true" value="<?= $contas_pagar->valor_juros_multa ?>">
                                    </div>
                                </div>
                                <div class="form-group col-md-3">
                                    <label class="control-label"
                                        for="inputValorPagar<?= $contas_pagar->cod_movimento_conta ?>">Valor a
                                        Pagar</label>
                                    <div class="input-group">
                                        <div class="input-group-prepend">
                                            <span class="input-group-text">R$</span>
                                        ...
                                        <input type="text" class="form-control" class="form-control" readonly
                                            id="inputValorPagar<?= $contas_pagar->cod_movimento_conta ?>" type="text"
                                            name="ValorPagar" data-mask="#.##0,00" data-mask-reverse="true"
                                            value="<?= set_value('ValorPagar'); ?>">
                                    </div>
                                </div>
                            </div>
                        </form>
            ...
            <div class="modal-footer">
                <button type="submit" class="btn btn-primary"
                    form="formTitulo<?= $contas_pagar->cod_movimento_conta ?>"><i class="fas fa-save"></i>
                    Salvar</button>
                <button type="button" class="btn btn-secondary" data-dismiss="modal">Cancelar</button>
            </div>
        </div>
